...
def Min_alpha_iteration(G, model,request_inf,length_path,bottleneck_link):
    ...
    # 求解
    start_time = time.perf_counter()
    model.solve(GUROBI_CMD(options=[('TimeLimit','10'),('MipGap','0.003')],msg=0))
    print("用时：", time.perf_counter()-start_time, " s")
...
for topo_c in topo_choice1:
    ...
    length_path0=length_path0_list[topo_choice.index(topo_c)]
    G1 = copy.deepcopy(G)
    G2 = copy.deepcopy(G)
    G3 = copy.deepcopy(G)
    ...
    temp['request2'].append(len(request_inf['request_data']))
    temp['request3'].append(len(request_inf['request_data']))
    improve_route_iteration(G1, length_path, request_inf1, supplement_key0,temp)
    print("----------------------------------------------------------------")
    compare_route1(G3, length_path,request_inf, request_inf3, supplement_key0,temp)
    print("################################################################")
    compare_route2(G2, length_path, request_inf2, supplement_key0,temp)
    print("****************************************************************")
    for brust_num in range(15,16,2):
        writer = pd.ExcelWriter(store_path+data_choice+'_'+'result_time.xlsx')
        for i in range(450):#500
            ...
            request_inf0=creat_request3(G,brust_num,32,0)
            request_inf=copy.deepcopy(request_inf0)
            request_inf1 = copy.deepcopy(request_inf0)
            request_inf2 = copy.deepcopy(request_inf0)
            request_inf3 = copy.deepcopy(request_inf0)
            G11 = copy.deepcopy(G1)
            G22 = copy.deepcopy(G2)
            G33 = copy.deepcopy(G3)
            print("This is ",topo_c,':',i,'.',brust_num,'/'," test")
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result1['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result1)
            result1['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result1)
            result1['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result1)
            result1['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final.keys():
                final1[key]=final1[key]+result1[key]
            ...
            temp['request2'].append(len(request_inf['request_data']))
            temp['request3'].append(len(request_inf['request_data']))
            improve_route_iteration(G11, length_path, request_inf1, supplement_key0,temp)
            print("----------------------------------------------------------------")
            compare_route1(G33, length_path,request_inf, request_inf3, supplement_key0,temp)
            print("################################################################")
            compare_route2(G22, length_path, request_inf2, supplement_key0,temp)
            print("****************************************************************") 
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result2['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result2)
            result2['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result2)
            result2['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result2)
            result2['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final2.keys():
                final2[key]=final2[key]+result2[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result3['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result3)
            result3['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result3)
            result3['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result3)
            result3['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final3.keys():
                final3[key]=final3[key]+result3[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result4['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result4)
            result4['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result4)
            result4['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result4)
            result4['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final4.keys():
                final4[key]=final4[key]+result4[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result5['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result5)
            result5['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result5)
            result5['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result5)
            result5['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final5.keys():
                final5[key]=final5[key]+result5[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result6['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result6)
            result6['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result6)
            result6['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result6)
            result6['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final6.keys():
                final6[key]=final6[key]+result6[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result7['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result7)
            result7['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result7)
            result7['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result7)
            result7['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final7.keys():
                final7[key]=final7[key]+result7[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result8['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result8)
            result8['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result8)
            result8['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result8)
            result8['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final8.keys():
                final8[key]=final8[key]+result8[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result9['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result9)
            result9['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result9)
            result9['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result9)
            result9['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final9.keys():
                final9[key]=final9[key]+result9[key]
            ...
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
            result10['error_link'].append(brust_num)
            improve_route_iteration(G11, length_path0, request_inf1, supplement_key,result10)
            result10['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path0, request_inf2, supplement_key,result10)
            result10['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path0,request_inf,request_inf3,supplement_key,result10)
            result10['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final10.keys():
                final10[key]=final10[key]+result10[key]

    res = pd.DataFrame(final1)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final1')
    res = pd.DataFrame(final2)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final2')
    res = pd.DataFrame(final3)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final3')
    res = pd.DataFrame(final4)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final4')
    res = pd.DataFrame(final5)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final5')
    res = pd.DataFrame(final6)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final6')
    res = pd.DataFrame(final7)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final7')
    res = pd.DataFrame(final8)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final8')
    res = pd.DataFrame(final9)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final9')
    res = pd.DataFrame(final10)  # 创建DataFrame
        # 存表，去除原始索引列（0,1,2...）
    res.to_excel(writer, index=False, sheet_name='final10')
