...
for i in range(10):
    ...
    improve_route(G1, length_path, request_inf1, supplement_key,temp)
    print("----------------------------------------------------------------")
    request_inf2 = copy.deepcopy(request_inf)
    compare_route1(G2, length_path,request_inf, request_inf2, supplement_key,temp)
    print("################################################################")
    compare_route2(G3, length_path, request_inf3, supplement_key,temp)
    print("****************************************************************")
# print(G.size())
for i in range(400):
    for j in range(30,66,5):
            result={
                "error_link":[],
                "abandon1":[],
                "min1":[],
            ...
            link_error(G11,G22,G33,j)

            print("This is 1.",i,".",j," test")
            print("request is",request_inf)
            print("request_number is",len(request_inf['request_data']))
