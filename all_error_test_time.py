...
def update_key(G, update_data):
    for i in range(len(update_data['origin'])):
        if G.has_edge(update_data['origin'][i],update_data['destination'][i]):
...
topo_choice=['Chinanet']#'Chinanet','Geant2012','Dataxchange','Sprint','EliBackbone'
data_choice='error'
max1=[9]
max2=[36]
...
for topo_c in topo_choice:
    ...
    writer = pd.ExcelWriter(store_path+data_choice+'_'+'result.xlsx')
    link_range=[[25],[0,5,10,15,20,25,30,35,40,45,50,55,60,30,35,40,45,50,55,30,35,40,45,50,55],
    ...
    for i in range(300):
        for j in link_range[topo_choice.index(topo_c)]:
            ...
            print("This is ",topo_c,':',i,'.',j,'/'," test1")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result1['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result1)
            result1['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result1)
            result1['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result1)
            result1['request3'].append(len(request_inf['request_data']))
            print("################################################################")

            for key in final1.keys():
                final1[key]=final1[key]+result1[key]

            request_inf1 = copy.deepcopy(request_inf)
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test2")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result2['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result2)
            result2['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result2)
            result2['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result2)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test3")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result3['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result3)
            result3['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result3)
            result3['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result3)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test4")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result4['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result4)
            result4['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result4)
            result4['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result4)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test5")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result5['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result5)
            result5['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result5)
            result5['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result5)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test6")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result6['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result6)
            result6['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result6)
            result6['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result6)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test7")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result7['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result7)
            result7['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result7)
            result7['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result7)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test8")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result8['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result8)
            result8['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result8)
            result8['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result8)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test9")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result9['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result9)
            result9['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result9)
            result9['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result9)
            ...
            request_inf2 = copy.deepcopy(request_inf)
            request_inf3 = copy.deepcopy(request_inf)
            print("This is ",topo_c,':',i,'.',j,'/'," test10")
            print("request is",request_inf)
            # print("request1 is",request_inf1)
            # print("request2 is",request_inf2)
            # print("request2 is",request_inf2)
            print("request_number is",len(request_inf['request_data']))
            result10['error_link'].append(j)
            improve_route_iteration(G11, length_path, request_inf1, supplement_key,result10)
            result10['request1'].append(len(request_inf['request_data']))
            print("----------------------------------------------------------------")
            compare_route2(G22, length_path, request_inf2, supplement_key,result10)
            result10['request2'].append(len(request_inf['request_data']))
            print("****************************************************************")
            compare_route1(G33, length_path,request_inf,request_inf3,supplement_key,result10)
